...
public class CruddemoApplication {
	...
	private void createMultiStudents(StudentDAO studentDAO) {
		...
		Student tempStudent1 = new Student("Dash", "Jow", "dash@luv2code.com");
		Student tempStudent2 = new Student("John", "Carter", "john@luv2code.com");
		Student tempStudent3 = new Student("Cleb", "Bambam", "bambam@luv2code.com");
